...
export class App {
    ...
    initListeners() {
        ...
        vp.addEventListener('dragenter', (e) => { e.preventDefault(); showOverlay(); });
        vp.addEventListener('dragover', (e) => { e.preventDefault(); showOverlay(); });
        vp.addEventListener('dragleave', (e) => { e.preventDefault(); hideOverlay(); });
